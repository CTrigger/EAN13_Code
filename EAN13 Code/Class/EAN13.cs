...
namespace EAN13_Code.Class
{
    class EAN13
    {
        ...
        public EAN13(string EAN)
        {
            ...
            Digit = Convert.ToString(10 - ((Par + Impar) % 10));
            if (Digit == "10")
            {
                Digit = "2";
            }
            ...
            for (int i = 1; i <= 7; i++)
            {
                if (i < 7)
                {
                    ...
                    if (i == 2)
                    {
                        if ((int)Char.GetNumericValue(FinalEAN[i]) < 4)
                        {
                            Code[i] = L[(int)Char.GetNumericValue(FinalEAN[i])];
                            group = group + "L";
                        }
                    ...
                    if (i==3)
                    {
                        if (FinalEAN[i] == '0' || FinalEAN[i] == '3' || FinalEAN[i] == '4' || FinalEAN[i] == '7' || FinalEAN[i] == '8')
                        {
                            Code[i] = L[(int)Char.GetNumericValue(FinalEAN[i])];
                            group = group + "L";
                        }
                    ...
                    if (i == 5)
                    {
                        if (FinalEAN[i] == '0' || FinalEAN[i] == '2'|| FinalEAN[i] == '5' || FinalEAN[i] == '6' || FinalEAN[i] == '7')
                        {
                            Code[i] = L[(int)Char.GetNumericValue(FinalEAN[i])];
                            group = group + "L";
                        }
                    ...
                    if (i == 6)
                    {
                        if (FinalEAN[i] == '0' || FinalEAN[i] == '3' || FinalEAN[i] == '6' || FinalEAN[i] == '8' || FinalEAN[i] == '9')
                        {
                            Code[i] = L[(int)Char.GetNumericValue(FinalEAN[i])];
                            group = group + "L";
                        }
